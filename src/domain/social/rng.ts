...
// Deterministic Seeded PRNG for Social Subsystem, canonical Mulberry32 + SplitMix32 adapter.
...
export function createRngAdapter(rng: RngStateData): SeededRng {
  ...
  const seeded = new SeededRng(rng.seed);
