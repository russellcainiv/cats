 ...
 *
 * Implements deterministic seeded RNG with serialization, labeled draws,
 * integer/float/choice helpers, and explicit immutability so no side-effect draws occur.
 */
